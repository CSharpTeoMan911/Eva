...
namespace Eva_5._0
{
    ...
    public partial class MainWindow : Window
    {
        ...
        // Play a 25khz inaudible '.wav' sound file in the background to keep bluetooth devices activated.
        // All bluetooth devices have a sleep function which will turn the device's speakers off in 
        // order to save energy. This feature will make the noises generated by Eva inaudible if the
        // speakers are not activated at the moment.
        private void RunStaticBackgroundNoise()
        {
            // Run the background noise in a thread-pool thread in order for the process to be non-blocking.
            Task.Run(async () => {
                await A_p_l____And____P_r_o_c.sound_player.Play_Sound(Properties.Sound_Player.Sounds.BackgroundNoiseEffect);
            });
        }
