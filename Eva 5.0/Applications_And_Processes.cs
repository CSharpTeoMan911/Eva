...
namespace Eva_5._0
{
    internal class Applications_And_Processes
    {
        protected readonly static System.Collections.Concurrent.ConcurrentDictionary<string, string> Application_Name__And__Application_Executable_Name = new System.Collections.Concurrent.ConcurrentDictionary<string, string>();

        protected readonly static System.Collections.Concurrent.ConcurrentDictionary<string, string> Application_Name__And__Application_Process_Name = new System.Collections.Concurrent.ConcurrentDictionary<string, string>();

        protected readonly static System.Collections.Concurrent.ConcurrentDictionary<string, string> Application_Name__And__Application_Not_Found_Error_Download_Link = new System.Collections.Concurrent.ConcurrentDictionary<string, string>();
        ...
        public Applications_And_Processes()
        {
            ...
            Application_Name__And__Application_Process_Name.TryAdd("timer", "timer");
