...
namespace Eva_5._0.Properties
{
    public class Sound_Player
    {
        ...
        // Play an inaudible sound in the background to keep bluetooth devices activated. All
        // bluetooth devices have a sleep function which will turn the device's speakers off
        // in order to save energy. This feature will make the noises generated by Eva
        // inaudible if the speakers are not activated at the moment.
        public void PlayBackgroundNoise()
        {
            WaveFormat wave_format = new WaveFormat(16000,8,1);
